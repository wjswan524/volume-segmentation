# -*- coding: utf-8 -*-
"""
A simple function to define and retrieve the neighborhood. Accepts the current
voxel (pt), the indicator array of checked points (checked), and the 
dimensions of the volume (img.shape). Adapted directly from Matt Hancock, 
< http://notmatthancock.github.io >, to whom all credit for this script is due.
"""
